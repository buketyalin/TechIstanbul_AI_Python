...
Modelin  giriş verileri(x) bulunduğu ancak bu verilere ait doğru cevapların etiketleri bulunmadığı ML öğrenme türüdür


Temel Yapı:
    X(Features/Özellikler) --> MODEL --> Gruplar / Desenler

Bu öğrenmede LABEL yoktuuuuurrrrr
...
# --------------------------------------------
    ...
    # numerate(X), bir listenin elemanlarını indeksleriyle birlikte dolaşmanı sağlar.
    # Örnek: X=["a","b","c"]
    ...
    # Alternatif kod:    for i in range(len(X)):
    #                      print(i, X[i])
